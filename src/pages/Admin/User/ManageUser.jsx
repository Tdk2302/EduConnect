...
const ManageUser = () => {
  ...
  const handleEditTeacher = async (user) => {
    ...
    try {
      ...
      const statusValue =
        teacherData.status === "1" || teacherData.status === 1
          ? "Active"
  ...
  return (
    <Box
      ...
      sx={{ width: "100%", maxWidth: 1300, mx: "auto" }}
    >
      <Typography
        className="manage-user-title"
        variant="h3"
        fontWeight={900}
        mb={4}
        color="#4B1EFF"
        ...
        >
          {ROLE_CATEGORIES.map((cat) => (
            <Tab
              ...
              iconPosition="start"
              sx={{ fontWeight: 800, fontSize: 18, minWidth: 140 }}
            />
          ))}
        </Tabs>
        <Box flex={1} />
      ...
      <Box
        ...
        sx={{
          mt: 2,
          borderRadius: 5,
          boxShadow: "0 4px 32px 0 rgba(80,80,80,0.10)",
          background: "#fff",
        }}
      >
        <TableUser
            ...
            <Box>
              ...
              <Grid container spacing={4} justifyContent="center">
                <Grid item xs={12} md={6}>
                  <Paper
                    elevation={2}
                    sx={{ p: 4, borderRadius: 4, mb: 2, minWidth: 320 }}
                  >
                    <Typography
                      fontWeight={700}
                      fontSize={18}
                      ...
                      <InfoRow
                        ...
                        value={
                          SUBJECT_OPTIONS.find(
                            (s) => s.value === teacherDetail.subjectId
                          )?.label || teacherDetail.subjectId
                        }
                      />
                      <InfoRow
                        label="Trạng thái"
                        value={
                          ...
                          teacherDetail.status === 1
                            ? "Hoạt động"
                            : teacherDetail.status === "0" ||
                                teacherDetail.status === 0 ||
                                teacherDetail.status === "2" ||
                                teacherDetail.status === 2
                              ? "Không hoạt động"
                ...
                <Grid item xs={12} md={4}>
                  <Paper
                    elevation={2}
                    sx={{ p: 4, borderRadius: 4, mb: 2, minWidth: 220 }}
                  >
                    <Typography
                      fontWeight={700}
                      fontSize={18}
                    ...
                    <Box display="flex" flexDirection="column" gap={2}>
                      <InfoRow
                        label="Ngày tạo"
                        value={
                          teacherDetail.createAt
                            ? teacherDetail.createAt.split("T")[0]
                            : "-"
                        }
                      />
                    </Box>
            ...
            >
              ...
              <Box display="flex" alignItems="center" gap={1}>
                ...
                <Typography fontSize={19}>
                  SĐT: <b>{selectedUser.phoneNumber || "-"}</b>
                </Typography>
              </Box>
              <Box display="flex" alignItems="center" gap={1}>
                <VerifiedUserIcon
                  color={selectedUser.isActive ? "success" : "disabled"}
                />
                <Typography fontSize={19}>
                  Trạng thái:{" "}
                  <Chip
                ...
                <Typography fontSize={19}>
                  ...
                  <b>
                    {selectedUser.createAt
                      ? selectedUser.createAt.split("T")[0]
                      : "-"}
                  </b>
                </Typography>
              </Box>
        ...
        <DialogActions sx={{ justifyContent: "center" }}>
          <Button
            ...
            sx={{
              ...
              borderRadius: 3,
              fontSize: 20,
              background: "linear-gradient(90deg,#4B1EFF 0%,#6A5BFF 100%)",
            }}
          >
            Đóng
          </Button>
      ...
      >
        <DialogTitle
          sx={{ textAlign: "center", fontWeight: 800, fontSize: 24 }}
        >
          Chỉnh sửa giáo viên
        </DialogTitle>
        <DialogContent>
        ...
        <DialogActions sx={{ justifyContent: "center" }}>
          <Button onClick={handleCloseEditTeacher} color="secondary">
            Hủy
          </Button>
          <Button
      ...
      >
        ...
        >
          <DeleteForeverIcon
            sx={{ mr: 1, fontSize: 28, verticalAlign: "middle" }}
          />{" "}
  ...
  return (
    <Box display="flex" alignItems="center" gap={2} sx={{ mb: 0.5 }}>
      <Typography
        ...
        sx={{ minWidth: 120, flexShrink: 0, textAlign: "left" }}
      >
        {label}:
      </Typography>
      <Typography
